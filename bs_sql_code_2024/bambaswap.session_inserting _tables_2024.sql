...
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
DROP TABLE bambaswap_combined_jan_aug_2024

CREATE TABLE bambaswap_combined_jan_aug_2024
(
    date TIMESTAMP,
    phone_number TEXT,
    amount_recieved INT,
...
INSERT INTO bambaswap_combined_jan_aug_2024
...
UPDATE bambaswap_combined_jan_aug_2024
SET phone_number = 
...
ALTER TABLE bambaswap_combined_jan_aug_2024
